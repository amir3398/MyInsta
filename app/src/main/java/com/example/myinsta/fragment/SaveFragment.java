...
public class SaveFragment extends Fragment {
    ...
    private void init(View v) {
        ...
        recyclerSave = v.findViewById(R.id.save_recycler);
        recyclerSave.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    private  void getData(){
        ...
        RetrofitClient.getInstance(getContext()).getApi().getSave(u).enqueue(new Callback<PostModel>() {
            @Override
